...
describe("RequestEditPage tests", () => {
  ...
  describe("tests where backend is working normally", () => {
    ...
    expect(requestBody.recommendationTypes).toBe(
      "test_details"
    );
...
//   describe("tests where backend is working normally without Other", () => {
//     const axiosMock = new AxiosMockAdapter(axios);
...
//       await waitFor(() => expect(mockToast).toBeCalled());
//       expect(mockToast).toBeCalledWith(
//         "Request Updated - id: 17 professor name: testnameother professorEmail: testnameotheremail@ucsb.edu requester name: testname2 recommendation: PhD program details: test details 2",
//       );
