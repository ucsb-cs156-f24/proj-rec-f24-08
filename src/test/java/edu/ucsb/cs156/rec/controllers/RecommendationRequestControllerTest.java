...
public class RecommendationRequestControllerTest extends ControllerTestCase {
    ...
    public void an_admin_user_can_post_a_new_recommendation_request() throws Exception {
        ...
        MvcResult response = mockMvc.perform(
                post("/api/recommendationrequest/post?professorName=Conrad&professorEmail=phtcon@ucsb.edu&requesterName=Amanda&recommendationTypes=rec type&details=details&status=status&submissionDate=2022-01-03T00:00:00&completionDate=2022-01-03T00:00:00")
                        .with(csrf()))
                .andExpect(status().isOk()).andReturn();
